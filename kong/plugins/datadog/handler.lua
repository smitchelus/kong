...
local function allow_user_metric(message, identifier)
  if message.authenticated_entity ~= nil and
          message.authenticated_entity.consumer ~= nil and
          message.authenticated_entity.consumer[identifier] ~= nil then
    return true, message.authenticated_entity.consumer[identifier]
  end
  return false
end
